// @ZBS {
//		*COMPONENT_NAME guilight
//		*MODULE_OWNER_NAME glgui
//		*GROUP modules/gui
//		*REQUIRED_FILES guilight.h
// }
...
struct GUI3DDirectionArrow : GUIObject {
	GUI_TEMPLATE_DEFINTION(GUI3DDirectionArrow);
...
GUI_TEMPLATE_IMPLEMENT(GUI3DDirectionArrow);
...
void GUI3DDirectionArrow::queryOptSize( float &w, float &h ) {
	w = 100.f;
	h = 100.f;
}

void GUI3DDirectionArrow::sendMsg() {
	if( hasAttr( "sendMsg" ) ) {
		zMsgQueue( "%s matPtr=0x%x", getAttrS("sendMsg"), &mat );
	}
}
